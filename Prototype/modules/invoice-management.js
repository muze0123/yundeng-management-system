    ...
    (function () {
      ...
      function renderRedSynced() {
        ...
        if (redSubtab === 'corrections') {
          ...
          return '<section class="invoice-block"><div class="invoice-filter-flow">' + dataScope + '</div></section><section class="invoice-block"><div class="invoice-list-header"><h2 class="invoice-list-title">更正申请列表</h2><span class="invoice-list-total">共 <span class="mono">' + correctionRows.length + '</span> 条</span></div><div class="invoice-list-toolbar"><span></span><div class="invoice-list-actions">' + btn('refresh', '刷新', 'refresh-cw', 'invoice-btn-default') + btn('export', '导出更正申请', 'download', 'invoice-btn-default') + '</div></div><div class="invoice-table-wrap" data-anno="52"><table class="invoice-table data-table" aria-label="更正申请列表"><thead><tr><th>更正申请 / 时间</th><th>受票主体 / 申请人</th><th>目标蓝票 / 原因</th><th>整组金额</th><th>更正状态</th><th>重开草稿</th><th>操作</th></tr></thead><tbody>' + (correctionHtml || '<tr><td colspan="7">' + empty('暂无更正申请', '创建财务纠错后，申请会显示在这里。', 'file-pen-line') + '</td></tr>') + '</tbody></table></div>' + paginate(correctionRows.length, 1, 20, '') + '</section>';
        }
